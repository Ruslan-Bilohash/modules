...
<div class="section">
    ...
    <ul>
        ...
        <li><strong>booking.php</strong> — Модуль бронювання: управління бронюваннями (наприклад, для послуг або подій).</li>
...
<div class="section norwegian">
    ...
    <ul>
        <li><strong>admins.html</strong> — HTML-mal for adminhåndtering (mulig statisk versjon eller supplement til admins.php).</li>
